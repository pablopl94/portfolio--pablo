...
<div align="center">
  <a href="https://linkedin.com/in/pablopl94">
    <img src="./public/yo.webp" alt="Pablo Prieto López" width="150" height="150" style="border-radius: 50%; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  </a>
  <br><br>
...
|------------|-------------|
| **[Astro](https://astro.build/)** | Framework web moderno para contenido estático |
| **[Tailwind CSS](https://tailwindcss.com/)** | Framework de CSS utilitario |
| **[Onest Font](https://onest.dev/)** | Fuente utilizada |
| **[Netfily](https://netfily.com/)** | Plataforma de despliegue |
